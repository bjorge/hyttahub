...
class DeleteTreeScreen extends StatefulWidget {
  const DeleteTreeScreen({
    super.key,
  ...
  @override
  State<DeleteTreeScreen> createState() => _DeleteTreeScreenState();
}

class _DeleteTreeScreenState extends State<DeleteTreeScreen> {
    ...
    return BlocProvider<AppSubmitBloc>(
      ...
      child: BlocConsumer<AppSubmitBloc, BaseSubmitState<SubmitAppEvent>>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              title: Text(l10n.app_deleteTreeTitle),
            ...
            body: Form(
              ...
              child: CommonSubmitFormLayout<SubmitAppEvent>(
                submitState: state,
                children: [
                  DeleteTreeConfirmationCheckbox(
                    formKey: _formKey,
                    labelText: l10n.app_deleteTreeConfirmation,
                  ),
                ],
              ),
            ),
...
class DeleteTreeConfirmationCheckbox
    extends
        BaseConfirmationCheckbox<
          ...
          SubmitAppEvent
        > {
  const DeleteTreeConfirmationCheckbox({
    super.key,
