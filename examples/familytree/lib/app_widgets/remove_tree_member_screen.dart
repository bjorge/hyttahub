...
class RemoveTreeMemberScreen extends StatefulWidget {
  const RemoveTreeMemberScreen({
    super.key,
  ...
  @override
  State<RemoveTreeMemberScreen> createState() => _RemoveTreeMemberScreenState();
}

class _RemoveTreeMemberScreenState extends State<RemoveTreeMemberScreen> {
    ...
    return BlocProvider<AppSubmitBloc>(
      ...
      child: BlocConsumer<AppSubmitBloc, BaseSubmitState<SubmitAppEvent>>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            appBar: AppBar(
              title: Text(l10n.app_removeTreeMemberTitle),
            ...
            body: Form(
              ...
              child: CommonSubmitFormLayout<SubmitAppEvent>(
                submitState: state,
                children: [
                  RemoveTreeMemberConfirmationCheckbox(
                    formKey: _formKey,
                    labelText: l10n.app_removeTreeMemberConfirmation,
                  ),
                ],
              ),
            ),
...
class RemoveTreeMemberConfirmationCheckbox
    extends
        BaseConfirmationCheckbox<
          ...
          SubmitAppEvent
        > {
  const RemoveTreeMemberConfirmationCheckbox({
    super.key,
