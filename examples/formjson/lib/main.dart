...
import 'package:formjson/app_blocs/app_replay.dart';
import 'package:formjson/firebase_options.dart';
import 'package:formjson/routers/app_router.dart';
...
Future<void> main() async {
  ...
  HyttaHubOptions.firebaseRootCollection =
      'formjson'; // the appName, do not change
  HyttaHubOptions.appId = 'hyttahub.example.formjson'; // do not change
